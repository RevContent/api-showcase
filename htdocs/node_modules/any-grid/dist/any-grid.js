...
AnyGrid.prototype._getItemLayoutPosition = function( item ) {
    ...
    var paddingTop = parseFloat(revUtils.getComputedStyle(item.element, 'padding-top'));
    var paddingRight = parseFloat(revUtils.getComputedStyle(item.element, 'padding-right'));
    var paddingBottom = parseFloat(revUtils.getComputedStyle(item.element, 'padding-bottom'));
    var paddingLeft = parseFloat(revUtils.getComputedStyle(item.element, 'padding-left'));

    //promote child padding $$$
    var child = item.element.children[0];
    var childPaddingTop = parseFloat(revUtils.getComputedStyle(child, 'padding-top'));
    var childPaddingRight = parseFloat(revUtils.getComputedStyle(child, 'padding-right'));
    var childPaddingBottom = parseFloat(revUtils.getComputedStyle(child, 'padding-bottom'));
    var childPaddingLeft = parseFloat(revUtils.getComputedStyle(child, 'padding-left'));
