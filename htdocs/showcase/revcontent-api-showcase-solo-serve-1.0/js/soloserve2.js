...
if (typeof RevContentSolo != 'undefined') {
    ...
    if (RevContentSolo.devices && !revDetect.show(RevContentSolo.devices)) {
...
if (typeof hideSoloServe === 'undefined') {
    ...
    var css = '<style>'+
        ...
        'padding:0!important;'+
        '}'+
        '#rc-solo #rc_cont_'+solo_widget_id+' .rc-headline {'+
        ...
        'width: 92%!important;'+
        '}'+
        '#rc-solo #rc_cont_'+solo_widget_id+' .rc-provider {'+
        ...
        'line-height: 22px;'+
        '}'+
        '#rc-solo #rc_cont_'+solo_widget_id+' .rc-item-wrapper {'+
        'margin: 0!important;'+
        '}'+
        '#rc-solo #rc_cont_'+solo_widget_id+' .rc-photo-container {'+
        'border-top-left-radius: 3px;'+
        'border-top-right-radius: 3px;'+
        'max-height: 310px;'+
        '}'+
        '#rc-solo #rc_cont_'+solo_widget_id+' .rc-item {'+
        'width:100%!important;'+
        '}'+
        '#rc-solo .rc-branding {' +
        'width: auto;' +
        ...
        'width: 100%;' +
        '}'+
        '#rc-solo #rc_cont_'+solo_widget_id+' .rc-brand-wrapper {'+
        'position: absolute;' +
        'right: 0px;' +
        '}'+
        '#rc-solo #rc_cont_'+solo_widget_id+' .rc-brand-wrapper .rc-branding-label,'+
        '#rc-solo #rc_cont_'+solo_widget_id+' .rc-brand-wrapper .hateit {'+
        'position: relative;'+
        'top: 86px;'+
        ...
        'display: block;'+
        'width: 155px;'+
        'margin: 17px 0 16px 4%!important;'+
        'height: 40px;'+
        'overflow: hidden;'+
        '}'+
    ...
    var js = '<script type="text/javascript">'+
        '(function() {'+
        'var rcruntime = document.getElementById("hotnum_'+solo_widget_id+'");'+
        'rcruntime.innerHTML = rcruntime.innerHTML + rcruntimec();'+
        '})();'+

        'function rcclickfnc()'+
        '{'+
        'document.getElementById("rc_cont_'+solo_widget_id+'").querySelectorAll(".rc-cta")[0].click();'+
        '}'+
        'function rcruntimec()'+
        '{'+
    ...
    var html = '<div id="rc-solo" class="'+RevContentSolo.theme+'_rc_theme">'+
        ...
        '<div id="rc-widget-cdc64a" data-rc-widget data-widget-host="habitat" data-endpoint="//trends.revcontent.com" data-widget-id="'+solo_widget_id+'"></div>'+
        ...
        '<div class="hotnum" id="hotnum_' + solo_widget_id + '"></div>'+
        '</div>'+
        '</div>'+js+
        '</div>';
