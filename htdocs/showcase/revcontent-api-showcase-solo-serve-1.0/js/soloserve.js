...
'.rc-block-for-well {'+
    ...
    'height: 56px;'+
'}'+
'#rc-solo-border.social_rc_theme {'+
    'border-radius: 0px!important;'+
    'box-shadow: rgba(0, 0, 0, 0.0980392) 0px 0px 0px 1px inset, rgba(0, 0, 0, 0.0470588) 0px 1px 1px 0px;'+
'}'+
'#rc-solo-border.social_rc_theme .rc-w-43583 .rc-photo {'+
    'border-top-left-radius: 0px!important;'+
    'border-top-right-radius: 0px!important;'+
    'border-bottom: 1px solid #dedede;'+
'}'+
'#rc-solo-border.social_rc_theme .rc-hot-holder .rc-hot-flame {'+
    'display:none;'+
'}'+
'#rc-solo-border .rc-hot-holder .rc-hot-social {'+
    'display:none;'+
'}'+
'#rc-solo-border.social_rc_theme .rc-hot-holder .rc-hot-social {'+
    'position: relative;'+
    'top: 2px;'+
    'margin-right: 1px;'+
    'display:block;'+
    'float: left;'+
'}'+
'#rc-solo-border.social_rc_theme .rc-solo-more-button {'+
    'background: #E9EBEE;'+
    'border: 1px solid #dedede;'+
    'box-shadow:none;'+
'}'+
'#rc-solo-border.social_rc_theme .rc-solo-more-button:hover {'+
    'background: #dedede;'+
'}'+
'#rc-solo-border.social_rc_theme .rc-solo-more-buttontext {'+
    'color:#333;'+
'}'+
'#rc-solo-border.social_rc_theme #hotnum {'+
...
var html = '<div id="rc-solo-border" class="'+RevContentSolo.theme+'_rc_theme">'+
