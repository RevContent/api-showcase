  ...
  if (use_unique_names) {
    ...
    var jsText =
        ...
        '{'+
            ...
            'var totalruntimes = document.querySelectorAll("#rc-solo-' + solo_habitat_id + ' .hotnum").length;' +
    ...
    if (solo_widget_dest) {
        ...
        var js = '<script id="serve_' + solo_widget_id + '" type="text/javascript">' + jsText + '</script>';
    }
    ...
    var html = '<div id="' + target + '" class="'+RevContentSolo.theme+'_rc_theme">'+
        ...
        '<div class="rc-block-for-well" onclick="rcclickfnc()">'+
            ...
            '</div>'+
        '</div>' + (solo_widget_dest ? '' : js)+
    '</div>';


    if (solo_widget_dest) {
        var parent = document.querySelector(solo_widget_dest);
