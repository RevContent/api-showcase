...
'use strict';
    ...
    RevMore = function(opts) {
        ...
        this.innerWidget = function() {
            ...
            this.standardScript.src = "http://delivery.powr.mosterhout.dev2.dev.internal/serve.js.php?w="+ this.options.widget_id +"&t="+this.standardScript.id+"&c="+(new Date()).getTime()+"&width="+(window.outerWidth || document.documentElement.clientWidth)+"&referer="+referer;
