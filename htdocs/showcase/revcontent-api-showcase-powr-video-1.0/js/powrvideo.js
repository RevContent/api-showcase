...
( function( window, factory ) {
	...
	if (this.config.adserver == "dfp") {
		...
		var subid = (this.config.subid && this.config.subid != '') ? "&psid=" + this.config.subid : "";
	    var ret = "//vid.springserve.com/vast/" + tag + "?w=" + parseInt(this.getPlayerWidth()) + "&h=" + parseInt(this.getPlayerHeight()) + "&url=" + url + "&cb=" + new Date().getTime() + subid ;
	    return ret;
	} else {
