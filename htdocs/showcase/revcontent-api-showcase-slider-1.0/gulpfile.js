...
gulp.task('buildjs', ['minifycss', 'embedcss'], function() {
    ...
    return gulp.src(['./vendor/hammerjs/hammer.js', './vendor/mobile-detect/mobile-detect.js', './vendor/imagesloaded/imagesloaded.pkgd.js', './vendor/any-grid/dist/any-grid.js', '../js/revutils.js', '../js/revdialog.js', '../js/revdisclose.js', '../js/revdetect.js', '../js/revbeacon.js', '../js/revapi.js', './build/revslider.js'])
