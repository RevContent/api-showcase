        ...
        for (var i = 0; i < data.length; i++) {
            ...
            for (var j = 0; j < itemTypes[dataType].length; j++) {
                ...
                if (reactions) {
                    ...
                    js.src = this.options.host + '/reactions.js.php?r=5&url=' + itemData.target_url;
                    js.id = 'rc-react';
