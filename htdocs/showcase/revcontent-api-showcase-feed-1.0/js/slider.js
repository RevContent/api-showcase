    ...
    RevSlider.prototype.createRows = function(grid, rows, initial) {
        ...
        while (grid.nextRow < rows && i < 100) {
            ...
            if (items[0].element.matches(this.options.reactions_selector)) {
                ...
                var comment_b64 = '<a href="#' + (this.options.comment_div ? this.options.comment_div : 'rev-feed') + '" class="rev-reaction rev-reaction-comment"><div class="rev-reaction-icon rev-reaction-icon-comment"></div></a>';
        ...
        if (revDetect.mobile()) {
            ...
            revUtils.addEventListener(likeReactionElement, 'click', function(ev) {
                ...
                if (parseInt(likeReactionElement.getAttribute('data-active'))) {
                    ...
                    // item.element.querySelector('.rev-reactions-total-inner').insertAdjacentHTML('afterbegin', '<div style="z-index:' + (99) + ';" class="rev-reaction rev-reaction-'+ iconName +'"><div class="rev-reaction-inner"><div class="rev-reaction-icon rev-reaction-icon-'+ iconName +'"></div></div></div>');
    ...
    RevSlider.prototype.updateDisplayedItems = function(items, data) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            for (var j = 0; j < itemTypes[dataType].length; j++) {
                ...
                // var reactions = item.element.querySelector('.rev-reactions');
                // console.log(item.reactions, item.element);
