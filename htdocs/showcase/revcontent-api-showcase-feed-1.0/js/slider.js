    ...
    RevSlider.prototype.createRows = function(grid, rows, initial) {
        ...
        while (grid.nextRow < rows && i < 100) {
            ...
            if (items[0].element.matches(this.options.reactions_selector)) {
                ...
                var comment_b64 = '<a href="#' + (this.options.comment_div ? this.options.comment_div : 'rev-feed') + '" class="rev-reaction rev-reaction-comment"><div class="rev-reaction-icon"></div></a>';
