...
<meta name="author" content="rev:content">
<meta name="Description" content="rev:content - Native API Showcase" />
...
<div id="wrap">
  ...
  <header id="header"><div class="containing-wrapper">
    <div class="logo-wrapper">
      <h1 id="logo"><a href="index.html">rev:content</a></h1>
  ...
  <!-- end header -->
  <!-- start main nav --><div class="containing-wrapper menu">
  <nav id="main-nav">
    <div id="menu-close-button">&times;</div>
    <ul id="options" class="option-set clearfix" data-option-key="filter">
      <li class="selected"> <a href="#home">API Home</a> </li>
      <li> <a href="#portfolio" class="sub-nav-toggle">API Examples</a>
      ...
      <li> <a href="#about">API SUPPORT</a> </li>
      ...
      <div class="container">
        <div id="container" class="clearfix">
          ...
          <div class="element  clearfix col2-3 home about grey grid-fit">
            <p class="small">Native API Showcase</p>
            <h2>Hi, We’re rev:content. <br />
              A <strong>native network</strong> making brands live up to their full potential. That’s it. And this is our API showcase.</h2>
          </div>
          ...
          <div class="element  clearfix col1-3 home grey"> <a href="https://v2.revcontent.com/signup" data-title="Sign Up" >
            ...
            <h3>Join the native rev:olution</h3>
            <div class="bottom">
