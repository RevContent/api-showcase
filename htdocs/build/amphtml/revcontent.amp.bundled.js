...
( function (window, factory) {
    ...
    RevAMP.prototype.createAMPStyles = function () {
        ...
        var cssBaseStyles = '';
        var cssStyles = cssBaseStyles + ' ' + '/* inject:css */.rc-amp-ad-item,.rc-cta,.rc-headline{font-family:Tangerine,sans-serif}@font-face{font-family:Tangerine;src:url(https://fonts.googleapis.com/css?family=Tangerine)}body{margin:0;padding:0}.rc-cta{text-decoration:none;outline:0;color:#000}.rc-cta:hover{text-decoration:underline}.rc-amp-ad-item{margin-bottom:10px}.rc-headline{font-size:16px;margin:4px 0;padding:0}.rc-brand-label{font-size:9px;color:#777;text-align:left;clear:both;display:block}@media screen and (min-width:568px){.rc-amp-row[data-rows="2"] .rc-amp-ad-item{width:50%;float:left}.rc-amp-row[data-rows="3"] .rc-amp-ad-item{width:33.3333333333%;float:left}.rc-amp-row[data-rows="4"] .rc-amp-ad-item{width:25%;float:left}.rc-amp-row .rc-amp-ad-item .rc-amp-ad-wrapper{padding:0 10px}.rc-amp-ad-item{margin-bottom:0}.rc-headline{font-family:Tangerine,sans-serif;font-size:13px}}/* endinject */';
