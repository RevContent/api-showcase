 ...
 * @date - Thu Sep 22 2016 12:04:34 GMT-0400 (EDT)
 * @version v0.1.2
...
this.previousDirection=this.direction,this.direction="previous",this.createNextPageGrid(),click&&this.animateGrid()}},RevSlider.prototype.destroy=function(){this.grid.remove(),this.grid.destroy(),this.mc.set({enable:!1}),this.mc.destroy()},RevSlider});