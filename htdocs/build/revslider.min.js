 ...
 * @date - Wed Sep 21 2016 16:26:07 GMT-0400 (EDT)
 * @version v0.1.2
...
this.direction="previous",this.createNextPageGrid(),click&&this.animateGrid()}},RevSlider.prototype.destroy=function(){this.grid.remove(),this.grid.destroy(),this.mc.set({enable:!1}),this.mc.destroy()},RevSlider});